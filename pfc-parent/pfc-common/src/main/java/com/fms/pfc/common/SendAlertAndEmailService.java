...
public class SendAlertAndEmailService {
	...
	private StringBuffer generateCommonHtmlHead() {
		...
		return stringBuffer.append("<head>").append("</head>").append("<body>").append("<table border=1>")
				.append("<tr>").append("<th>No.</th>").append("<th>").append(LBL_HPL).append("</th>").append("<th>")
				.append(LBL_G2LOT).append("</th>").append("<th>").append(LBL_FILENAME).append("</th>").append("<th>")
				.append(LBL_FILESIZE).append(" (KB) ").append("</th>").append("<th>").append(LBL_FILEPATH)
				.append("</th>").append("<th>").append(LBL_ALERTTYPE).append("</th>").append("</tr>");
	}
	...
	private void generateTdData(StringBuffer stringBuffer, int rowno, OnDemandSearch ods) {
		...
		stringBuffer.append("<td>").append(convertToEmpty(ods.getFileName())).append("</td>");
		stringBuffer.append("<td align ='center'>").append(convertToEmpty(ods.getFileSize())).append("</td>");
		stringBuffer.append("<td>").append(convertToEmpty(ods.getFilePath())).append("</td>");
	...
	private String convertToEmpty(Object obj) {
