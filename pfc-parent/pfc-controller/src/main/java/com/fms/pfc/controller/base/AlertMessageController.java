...
public class AlertMessageController {
	...
	private final Logger logger = LoggerFactory.getLogger(AlertMessageController.class);
	...
	private static final int MENU_ITEM_ID = 804;
	private Map<String, Object> model = new HashMap<String, Object>();

	@Autowired
	public AlertMessageController(AlertMessageService alertMsgServ, CommonValidation commonValServ, Authority auth,
			TrxHisService trxHistServ, MessageSource msgSource, MenuRoleFunctionService mrfServ) {
		super();
