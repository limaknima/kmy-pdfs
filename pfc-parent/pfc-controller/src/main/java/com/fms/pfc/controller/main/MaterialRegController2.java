...
@Controller
@SessionScope
public class MaterialRegController2 {
	
	private static final Logger logger = LoggerFactory.getLogger(MaterialRegController2.class);
	...
	@Autowired
	public MaterialRegController2(Authority auth, CountryService countryServ, CommonValidation commonValServ,
	...
	@GetMapping("/main/material/rawMatlRegList2")
	public ModelAndView getRawMatlRegList(HttpServletRequest request, HttpServletResponse response,
		...
		return new ModelAndView("/main/material/rawMatlRegList2", model);
	}
	...
	@PostMapping("/main/material/searchRawMatlRegList2")
	...
	@GetMapping("/main/material/rawMatlRegForm2")
	public ModelAndView loadRawMatlRegForm(@RequestParam(name = "country", required = false) String countryId,
			@RequestParam(name = "matl", required = false) Integer matlId, HttpServletRequest request, HttpServletResponse response,
			HttpSession session) {

		model = auth.onPageLoad(model, request);
		model.put("header", "Add Raw Material Regulation Form");
		model.put("init", true);
		...
		return new ModelAndView("/main/material/rawMatlRegForm2", model);
	}
	 ...
	 * Download File
	 */
	@GetMapping("/main/material/rawMatlRegFormDownloadFile2")
	 ...
	 * Download View File
	 */
	@GetMapping("/main/material/rawMatlRegFormDownloadViewFile2")
	 ...
	 * Add to Table list
	 */
	@PostMapping(value = "/main/material/rawMatlRegForm2", params = "fileAction=add")
	 ...
	 * Update Table list
	 */
	@PostMapping(value = "/main/material/rawMatlRegForm2", params = "fileAction=update")
	 ...
	 * Remove Table list
	 */
	@PostMapping(value = "/main/material/rawMatlRegForm2", params = "fileAction=delete")
	 ...
	 * Save function
	 */
	@PostMapping(value = "/main/material/rawMatlRegForm2", params = "action=save")
	public ModelAndView saveRawMatlRegForm(@RequestParam(name = "regId") int regId,
		...
		if (!StringUtils.equals((String) model.get("screenMode"), CommonConstants.SCREEN_MODE_VIEW)) {
			regId = regServ.searchReglList(rawMatlId, countryId).get(0).getRegId();
			viewRawMatlRegForm(regId, countryId, request, response, session);
		}
	 ...
	 */
	@RequestMapping("/main/material/rawMatlRegFormView2")
	public ModelAndView viewRawMatlRegForm(@RequestParam(name = "regId") int regId,
		...
		model.put("regItems", reg);
		model.put("header", "View Raw Material Regulation Form");
	...
	@GetMapping("/main/material/rawMatlRegFormGetData2")
	...
	@PostMapping(value = "/main/material/rawMatlRegForm2", params = "action=edit")
	public ModelAndView editRawMatlRegForm(HttpServletRequest request, HttpSession session) {
		...
		model.put("btnSaveSts", false);
		model.put("btnSave", "Save");
		model.put("header", "Edit Raw Material Regulation Form");
		model.remove("success");
		model.remove("error");
		clearFileForm(model);
	...
	@GetMapping(value = "/main/material/getRegCatItemsByCountry2")
	@ResponseBody
